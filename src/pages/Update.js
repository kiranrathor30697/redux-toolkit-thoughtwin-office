    ...
    <>
      ...
      <form className='offset-4 border w-25 p-4 mt-5'>
          ...
          <div className='text-center mt-5'>
            <input type='email' placeholder='email' className='fs-5 text-center' onChange={(e)=>{handleChange(e)}} value={updt.email} /><br /><br />
          </div>
          ...
          <div className='text-center fs-5 ps-5 mt-5 '>
            <label htmlFor='img' className='my_img'>
              <input type='file' id='img' hidden className='ps-5 ' onChange={(e)=>{img_Change(e)}}/>
            </label>
          </div>
